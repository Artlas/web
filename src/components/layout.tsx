                    ...
                    >
                        <div className="z-50 flex flex-shrink-0 w-full">
                            ...
                            <div className="flex-1 flex justify-end sm:justify-between z-40 gap-4 px-2">
                                <h1 className="text-sm md:text-base lg:text-lg xl:text-xl 2xl:text-3xl hidden sm:flex items-center truncate flex-1 font-artlas-logo"   id={`section-${sectionName}`}>{sectionName}</h1>
                            </div>
